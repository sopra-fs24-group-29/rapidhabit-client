        ...
        <div className="flex flex-col items-center justify-start mt-8">
          <div className="w-custom-236 lg:w-custom-354">
            ...
            <FeedBox
              ...
              p2={
                "Peace and calm, Lena! Who else is finding their inner peace today?"
              }
            ></FeedBox>
            ...
            <FeedBox
              ...
              p2={"Way to go, John! Keep those steps coming!"}
            ></FeedBox>
            <FeedBox
              group={"G3"}
              color={"bg-purple-500"}
              ...
              p2={
                "Keep up the great work, everyone! Together, we can accomplish amazing things!"
              }
            ></FeedBox>
            <FeedBox
              group={"G1"}
              ...
              p2={
                "Great job, Alex! You’re inspiring us all to sweat a little more today."
              }
            ></FeedBox>
            <FeedBox
              group={"G3"}
              ...
              p2={"Well done, Sarah! What’s the next chapter about?"}
            ></FeedBox>
            ...
            <FeedBox
              ...
              p2={"Rock on, Michael! Keep strumming those chords!"}
            ></FeedBox>
            <FeedBox
              group={"G1"}
              color={"bg-green-500"}
              ...
              p2={
                "Excited to have you join us, Emma! Let's crush our goals together!"
              }
            ></FeedBox>
            <FeedBox
              group={"G3"}
              ...
              p2={
                "Congratulations, Emily! Keep up the consistency and feel the benefits of yoga."
              }
            ></FeedBox>
            <FeedBox
              group={"G2"}
              ...
              p2={
                "Welcome aboard, Michael! Together, we'll strive for progress, not perfection."
              }
            ></FeedBox>
